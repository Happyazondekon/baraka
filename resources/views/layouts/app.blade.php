...
<body class="font-sans antialiased bg-gray-50 text-gray-800"> {{-- Added default text color --}}
    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <a href="{{ route('home') }}">
                <img src="{{ asset('images/Baraka.png') }}" alt="Baraka Logo" class="h-10 w-auto"> {{-- Adjust height (h-10) as needed for your logo's appearance --}}
            </a>
    ...
    <footer class="bg-gray-900 text-white py-12"> {{-- Darker gray for more contrast --}}
        <div class="container mx-auto px-4">
            ...
            <div class="mt-10 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-gray-300 text-sm">
                <p>Copyright © {{ date('Y') }} Baraka. Tous droits réservés.</p> {{-- Updated copyright holder and dynamic year --}}
