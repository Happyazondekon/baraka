...
<head>
    ...
    <!-- Fonts -->
    {{-- Assuming you use a modern font, e.g., Figtree from Laravel Breeze --}}
...
<body class="font-sans antialiased bg-gray-50 text-gray-800"> {{-- Added default text color --}}
    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            ...
            <a href="{{ route('home') }}">
                <img src="{{ asset('images/AutoPermis.png') }}" alt="AutoPermis Logo" class="h-10 w-auto"> {{-- Adjust height (h-10) as needed for your logo's appearance --}}
            </a>
            ...
            <nav class="hidden md:flex space-x-6">
                @auth
                    ...
                    {{-- Assuming 'progression' route exists for authenticated users --}}
            ...
            <div class="flex items-center space-x-4">
                @auth
                    {{-- Dropdown utilisateur (using Alpine.js for interactivity) --}}
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" type="button" class="inline-flex justify-center items-center space-x-2 bg-green-600 text-white px-5 py-2.5 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2 transition duration-150 ease-in-out shadow-sm">
        ...
        {{-- Mobile Navigation (Conditional, using Alpine.js) --}}
        <div class="md:hidden" x-show="open" x-transition:enter="transition ease-out duration-200" x-transition:enter-start="opacity-0 -translate-y-4" x-transition:enter-end="opacity-100 translate-y-0" x-transition:leave="transition ease-in duration-150" x-transition:leave-start="opacity-100 translate-y-0" x-transition:leave-end="opacity-0 -translate-y-4">
    ...
    {{-- Footer Section --}}
    <footer class="bg-gray-900 text-white py-12"> {{-- Darker gray for more contrast --}}
        <div class="container mx-auto px-4">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-gray-300">
                        ...
                        <li><a href="#" class="hover:text-green-400 transition duration-150 ease-in-out">Politique de confidentialité</a></li> {{-- Added for common practice --}}
                    </ul>
                </div>
                ...
                <div class="md:col-span-2">
                    ...
                    <form action="#" method="POST" class="flex">
                        {{-- Add CSRF token for forms within the footer too --}}
                        @csrf 
            ...
            <div class="mt-10 pt-8 border-t border-gray-700 flex flex-col md:flex-row justify-between items-center text-gray-300 text-sm">
                <p>Copyright © {{ date('Y') }} AutoPermis. Tous droits réservés.</p> {{-- Updated copyright holder and dynamic year --}}
                <div class="flex space-x-5 mt-6 md:mt-0"> {{-- Increased spacing and margin for mobile --}}
