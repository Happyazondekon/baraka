...
@section('title', 'Créer un Examen Blanc')

@section('content')
<div class="max-w-6xl mx-auto">
    <div class="bg-white rounded-lg shadow">
        <div class="p-6 border-b border-gray-200">
            <h3 class="text-lg font-semibold">Créer un nouvel examen blanc</h3>
        </div>
        
        <form method="POST" action="{{ route('admin.mock-exams.store') }}" class="p-6">
            @csrf
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="title" id="title" required
                            ...
                            value="{{ old('title') }}"
                            placeholder="Ex: Examen Blanc Avancé">
                        @error('title')
                ...
                <div>
                    ...
                    <div class="mt-2 text-sm text-gray-600">
                        <span id="selectedCount">0</span> question(s) sélectionnée(s)
                    </div>
