        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
            ...
            <div class="group bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div class="bg-gradient-to-r from-blue-500 to-blue-600 p-8 text-white relative overflow-hidden">
                    ...
                    <!-- Background driving image -->
                    <div class="absolute bottom-0 right-0 opacity-90">
                        <img src="{{ asset('images/learning-car.png') }}" alt="Driving" class="w-20 h-20 object-contain">
                    </div>
                    <div class="relative z-10">
            ...
            <div class="group bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                <div class="bg-gradient-to-r from-slate-500 to-slate-600 p-8 text-white relative overflow-hidden">
                    ...
                    <div class="absolute bottom-0 right-0 opacity-90">
                        <img src="{{ asset('images/learning-car.png') }}" alt="Learning Car" class="w-20 h-20 object-contain">
                    </div>
                    <div class="relative z-10">
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex-1">
