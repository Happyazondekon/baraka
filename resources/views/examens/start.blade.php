                ...
                <div class="flex-1">
                    <div class="flex items-start justify-between">
                        ...
                        <button type="button" 
                                ...
                                onclick="readQuestion('{{ addslashes(strip_tags($question->question_text)) }}', 'tts-btn-{{ $question->id }}')"
...
<script>
// Copier ici le code JavaScript du composant QuestionReader
// (Le code de l'artifact précédent)
